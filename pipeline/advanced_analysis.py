...
try:
    ...
    GEO_SUPPORT = False
    print("GeoPandas not installed — skipping grid-based grouping")
...
if "Latitude" in df.columns and "Longitude" in df.columns:
    ...
    print(" Latitude/Longitude not found — skipping spatial grouping")
...
if "Latitude" in df.columns and "Longitude" in df.columns:
    ...
    if len(pdf_geo) > 20:  # need enough data points
        ...
        print(" Not enough geo points for clustering")
else:
